...
public sealed class CatalogFormOptions { public List<CategoryChoice> Categories { get; set; } = []; }
...
public sealed class BuildInfo { public string Version { get; set; } = "unknown"; public string Build { get; set; } = "unknown"; public string? BuildTimestampUtc { get; set; } public string Label { get; set; } = "YALA build unavailable"; }
